...
<li class="relative group">
    <button id="mobileDropdown2"
        class="flex justify-center items-center gap-2 text-fontLight xl:uppercase group-hover:text-secondary-400 duration-500 text-2xl xl:text-sm font-extralight xl:font-light xl:tracking-wider group">
