...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-x-20 gap-y-5 sm:gap-y-10">
    ...
    <div class="relative z-0 w-full mb-5 group">
        ...
        <input wire:model.live.lazy="name" type="text" name="name" id="name"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b border-primary-500 appearance-none  focus:outline-none focus:ring-0 focus:border-secondary-200 peer"
            placeholder=" " required />
        <label for="name"
            class="peer-focus:font-extralight font-extralight tracking-widest absolute text-sm text-gray-500  duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-secondary-400 peer-focus:dark:text-secondary-400 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Imię i nazwisko</label>
        @error('name')
    ...
    <div class="relative z-0 w-full mb-5 group">
        ...
        <textarea wire:model.live.lazy="content" name="content" id="content"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-b border-primary-500 appearance-none  focus:outline-none focus:ring-0 focus:border-secondary-200 peer min-h-[200px] max-h-[200px]"
...
<div class="flex justify-start lg:justify-end">
    ...
    class="border border-secondary-400 px-8 py-3 text-sm rounded-3xl bg-primary-400 text-fontDark hover:bg-secondary-400 hover:text-fontLight duration-500 w-3/4 sm:w-1/2 lg:w-3/4"><svg
